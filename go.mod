...
require (
	...
	github.com/ingka-group/nutanix-exporter v1.8.1
...
require github.com/ingka-group/nutanix-exporter v1.8.1
...
replace github.com/ingka-group/nutanix-exporter => ./nutanix-exporter
